...
//            ref_seq[i]=tolower(ref_seq[i]);
    ...
    // HD: sampling reads according to coverage profile
    bool next_pair_read_indel_cmp_cvg(seqRead& read_1, seqRead& read_2, cvgdist &dist);
